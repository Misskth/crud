...
<body>
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: purple;font-family: Verdana, Arial, Helvetica, sans-serif; color:white;">
    BTS ARMY FAN CLUB
  </nav>

  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #00fffff;">
<h5>| <a href="index.php">Home </a>| <a href="club colaboration.php">Club </a>| <a href="membership.php">Membership</a> | <a href="activity.php">Activities </a> | <a href="contact.php">Contact Us</a> | </h5></p>
</nav>
  <div class="container">
    <?php
    if (isset($_GET["msg"])) {
    ...
    ?>
	<p align="center"><h3>Club form for ARMY </h3></p>
